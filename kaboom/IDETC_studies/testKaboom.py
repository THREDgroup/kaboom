...
#         if __name__ == '__main__' or 'kaboom.IDETC_STUDIES.testKaboom':
...
#     plt.savefig(myPath+'/results/test_car.pdf')
#     plt.clf()
#
#
    ...
    plt.savefig(myPath + '/results/test_beam.pdf')
    plt.show()
    plt.clf()
    print("Figure saved to "+myPath + '/results/test_beam.pdf')
